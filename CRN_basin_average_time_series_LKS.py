...
def CRN_model_timeseries(dirname):
    ...
    for FileName in glob(dirname+"CRNvariable_short_cycle_*.er_frame_metadata"): # assigns a number to each iteration (i.e. for every .tree file in the directory)
...
if __name__ == "__main__":
    DataDirectory = "C://basin_data//Model_results//June2015_results//LowK//ER_metadata//"    
